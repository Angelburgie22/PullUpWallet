...
public class editarsuscripcion implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("editarsuscripcion"), "pullup.wallet.editarsuscripcion");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, editarsuscripcion.class);
...
public static RemoteObject _btnoperacionsuscripcion = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static pullup.wallet.suscripciones _suscripciones = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",editarsuscripcion.mostCurrent._activity,"alturaDispositivo",editarsuscripcion._alturadispositivo,"anchoDispositivo",editarsuscripcion._anchodispositivo,"aparicionMsgBox1",editarsuscripcion._aparicionmsgbox1,"aparicionMsgBox2",editarsuscripcion._aparicionmsgbox2,"aparicionMsgBox3",editarsuscripcion._aparicionmsgbox3,"btnMenu",editarsuscripcion.mostCurrent._btnmenu,"btnOperacionSuscripcion",editarsuscripcion.mostCurrent._btnoperacionsuscripcion,"colorCaja",editarsuscripcion._colorcaja,"cpBarraColor",editarsuscripcion.mostCurrent._cpbarracolor,"cur",editarsuscripcion.mostCurrent._cur,"Diapositivas",Debug.moduleToString(pullup.wallet.diapositivas.class),"diasPeriodo",editarsuscripcion._diasperiodo,"editarGasto",Debug.moduleToString(pullup.wallet.editargasto.class),"editarIngresoRecurrente",Debug.moduleToString(pullup.wallet.editaringresorecurrente.class),"editarIngresoUnico",Debug.moduleToString(pullup.wallet.editaringresounico.class),"editarMetaAhorro",Debug.moduleToString(pullup.wallet.editarmetaahorro.class),"Gastos",Debug.moduleToString(pullup.wallet.gastos.class),"Historiales",Debug.moduleToString(pullup.wallet.historiales.class),"idRegistro",editarsuscripcion._idregistro,"IngresosRecurrentes",Debug.moduleToString(pullup.wallet.ingresosrecurrentes.class),"IngresosUnicos",Debug.moduleToString(pullup.wallet.ingresosunicos.class),"lblContornoBoton",editarsuscripcion.mostCurrent._lblcontornoboton,"lblFondoDescripcion",editarsuscripcion.mostCurrent._lblfondodescripcion,"lblFondoMonto",editarsuscripcion.mostCurrent._lblfondomonto,"lblFondoNombre",editarsuscripcion.mostCurrent._lblfondonombre,"lblNombreVista",editarsuscripcion.mostCurrent._lblnombrevista,"Main",Debug.moduleToString(pullup.wallet.main.class),"MetasDeAhorro",Debug.moduleToString(pullup.wallet.metasdeahorro.class),"pnlNavInferior",editarsuscripcion.mostCurrent._pnlnavinferior,"pnlPeriodos",editarsuscripcion.mostCurrent._pnlperiodos,"pnlSelector",editarsuscripcion.mostCurrent._pnlselector,"rd1Ano",editarsuscripcion.mostCurrent._rd1ano,"rd1Mes",editarsuscripcion.mostCurrent._rd1mes,"rd1Semana",editarsuscripcion.mostCurrent._rd1semana,"rd2Semanas",editarsuscripcion.mostCurrent._rd2semanas,"rd3Semanas",editarsuscripcion.mostCurrent._rd3semanas,"registrarGasto",Debug.moduleToString(pullup.wallet.registrargasto.class),"registrarIngreso",Debug.moduleToString(pullup.wallet.registraringreso.class),"registrarMetaAhorro",Debug.moduleToString(pullup.wallet.registrarmetaahorro.class),"registrarSuscripcion",Debug.moduleToString(pullup.wallet.registrarsuscripcion.class),"sql",editarsuscripcion._sql,"Starter",Debug.moduleToString(pullup.wallet.starter.class),"Suscripciones",Debug.moduleToString(pullup.wallet.suscripciones.class),"Tutorial",Debug.moduleToString(pullup.wallet.tutorial.class),"txtDescripcion",editarsuscripcion.mostCurrent._txtdescripcion,"txtMonto",editarsuscripcion.mostCurrent._txtmonto,"txtNombre",editarsuscripcion.mostCurrent._txtnombre};
}
}