...
public class metasdeahorro implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("metasdeahorro"), "pullup.wallet.metasdeahorro");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, metasdeahorro.class);
...
public static pullup.wallet.suscripciones _suscripciones = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",metasdeahorro.mostCurrent._activity,"alturaDispositivo",metasdeahorro._alturadispositivo,"anchoDispositivo",metasdeahorro._anchodispositivo,"arrayPnlsOpciones",metasdeahorro.mostCurrent._arraypnlsopciones,"bmpTest",metasdeahorro.mostCurrent._bmptest,"btnMenu",metasdeahorro.mostCurrent._btnmenu,"cs",metasdeahorro.mostCurrent._cs,"cur",metasdeahorro.mostCurrent._cur,"cvsTest",metasdeahorro.mostCurrent._cvstest,"Diapositivas",Debug.moduleToString(pullup.wallet.diapositivas.class),"editarGasto",Debug.moduleToString(pullup.wallet.editargasto.class),"editarIngresoRecurrente",Debug.moduleToString(pullup.wallet.editaringresorecurrente.class),"editarIngresoUnico",Debug.moduleToString(pullup.wallet.editaringresounico.class),"editarMetaAhorro",Debug.moduleToString(pullup.wallet.editarmetaahorro.class),"editarSuscripcion",Debug.moduleToString(pullup.wallet.editarsuscripcion.class),"Gastos",Debug.moduleToString(pullup.wallet.gastos.class),"Historiales",Debug.moduleToString(pullup.wallet.historiales.class),"IngresosRecurrentes",Debug.moduleToString(pullup.wallet.ingresosrecurrentes.class),"IngresosUnicos",Debug.moduleToString(pullup.wallet.ingresosunicos.class),"lblContornoBoton",metasdeahorro.mostCurrent._lblcontornoboton,"Main",Debug.moduleToString(pullup.wallet.main.class),"nRegistros",metasdeahorro._nregistros,"pnlDeslizable",metasdeahorro.mostCurrent._pnldeslizable,"pnlNavInferior",metasdeahorro.mostCurrent._pnlnavinferior,"registrarGasto",Debug.moduleToString(pullup.wallet.registrargasto.class),"registrarIngreso",Debug.moduleToString(pullup.wallet.registraringreso.class),"registrarMetaAhorro",Debug.moduleToString(pullup.wallet.registrarmetaahorro.class),"registrarSuscripcion",Debug.moduleToString(pullup.wallet.registrarsuscripcion.class),"Relaciones",metasdeahorro.mostCurrent._relaciones,"sql",metasdeahorro._sql,"Starter",Debug.moduleToString(pullup.wallet.starter.class),"stu",metasdeahorro.mostCurrent._stu,"Suscripciones",Debug.moduleToString(pullup.wallet.suscripciones.class),"svPantalla",metasdeahorro.mostCurrent._svpantalla,"Tutorial",Debug.moduleToString(pullup.wallet.tutorial.class)};
}
}