...
public class registrarsuscripcion implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("registrarsuscripcion"), "pullup.wallet.registrarsuscripcion");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, registrarsuscripcion.class);
...
public static pullup.wallet.suscripciones _suscripciones = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",registrarsuscripcion.mostCurrent._activity,"alturaDispositivo",registrarsuscripcion._alturadispositivo,"anchoDispositivo",registrarsuscripcion._anchodispositivo,"aparicionMsgBox1",registrarsuscripcion._aparicionmsgbox1,"aparicionMsgBox2",registrarsuscripcion._aparicionmsgbox2,"aparicionMsgBox3",registrarsuscripcion._aparicionmsgbox3,"btnMenu",registrarsuscripcion.mostCurrent._btnmenu,"btnOperacionSuscripcion",registrarsuscripcion.mostCurrent._btnoperacionsuscripcion,"colorCaja",registrarsuscripcion._colorcaja,"cpBarraColor",registrarsuscripcion.mostCurrent._cpbarracolor,"cur",registrarsuscripcion.mostCurrent._cur,"Diapositivas",Debug.moduleToString(pullup.wallet.diapositivas.class),"diasPeriodo",registrarsuscripcion._diasperiodo,"editarGasto",Debug.moduleToString(pullup.wallet.editargasto.class),"editarIngresoRecurrente",Debug.moduleToString(pullup.wallet.editaringresorecurrente.class),"editarIngresoUnico",Debug.moduleToString(pullup.wallet.editaringresounico.class),"editarMetaAhorro",Debug.moduleToString(pullup.wallet.editarmetaahorro.class),"editarSuscripcion",Debug.moduleToString(pullup.wallet.editarsuscripcion.class),"egresosActuales",registrarsuscripcion._egresosactuales,"Gastos",Debug.moduleToString(pullup.wallet.gastos.class),"Historiales",Debug.moduleToString(pullup.wallet.historiales.class),"IngresosRecurrentes",Debug.moduleToString(pullup.wallet.ingresosrecurrentes.class),"IngresosUnicos",Debug.moduleToString(pullup.wallet.ingresosunicos.class),"lblContornoBoton",registrarsuscripcion.mostCurrent._lblcontornoboton,"lblFondoDescripcion",registrarsuscripcion.mostCurrent._lblfondodescripcion,"lblFondoMonto",registrarsuscripcion.mostCurrent._lblfondomonto,"lblFondoNombre",registrarsuscripcion.mostCurrent._lblfondonombre,"lblNombreVista",registrarsuscripcion.mostCurrent._lblnombrevista,"Main",Debug.moduleToString(pullup.wallet.main.class),"MetasDeAhorro",Debug.moduleToString(pullup.wallet.metasdeahorro.class),"pnlNavInferior",registrarsuscripcion.mostCurrent._pnlnavinferior,"pnlPeriodos",registrarsuscripcion.mostCurrent._pnlperiodos,"pnlSelector",registrarsuscripcion.mostCurrent._pnlselector,"rd1Ano",registrarsuscripcion.mostCurrent._rd1ano,"rd1Mes",registrarsuscripcion.mostCurrent._rd1mes,"rd1Semana",registrarsuscripcion.mostCurrent._rd1semana,"rd2Semanas",registrarsuscripcion.mostCurrent._rd2semanas,"rd3Semanas",registrarsuscripcion.mostCurrent._rd3semanas,"registrarGasto",Debug.moduleToString(pullup.wallet.registrargasto.class),"registrarIngreso",Debug.moduleToString(pullup.wallet.registraringreso.class),"registrarMetaAhorro",Debug.moduleToString(pullup.wallet.registrarmetaahorro.class),"sql",registrarsuscripcion._sql,"Starter",Debug.moduleToString(pullup.wallet.starter.class),"Suscripciones",Debug.moduleToString(pullup.wallet.suscripciones.class),"Tutorial",Debug.moduleToString(pullup.wallet.tutorial.class),"txtDescripcion",registrarsuscripcion.mostCurrent._txtdescripcion,"txtMonto",registrarsuscripcion.mostCurrent._txtmonto,"txtNombre",registrarsuscripcion.mostCurrent._txtnombre};
}
}