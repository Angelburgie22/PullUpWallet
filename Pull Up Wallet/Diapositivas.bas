...
Version=10.6
@EndOfDesignText@
'Modulo para la animacion y funcionamiento del slider, realizado por el usuario corwin42 en https://www.b4x.com/android/forum/threads/betterslidingpanels-nice-sliding-panels-with-page-indicator.12105/#content
Sub Process_Globals
	Dim PANEL_LEFT As Int : PANEL_LEFT = -2
	Dim PANEL_RIGHT As Int : PANEL_RIGHT = -3
	Dim leftPanel As Int = 0
...
Sub Initialize(sd As SlidingData, panels() As Panel, Rotate As Boolean, SlidingDuration As Int)
	...
	sd.currentPanel = -1
	sd.Panels = panels
	Tutorial.tmrAnimacion.Initialize("tmrAnimation", 2)
